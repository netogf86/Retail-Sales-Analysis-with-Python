...
1. Business Context
Retail companies generate large volumes of sales data, but raw data alone does not provide actionable insights.
This project analyzes retail sales data to understand sales performance, profitability, and the impact of discounts on business outcomes.
